...
!	open(20,err=100,file='dadj.dat')
!	do i = ie, is, -1
!	  read(20,*) rdum, alphar, alphai
!	  alpha(i,k,n) = -cmplx(alphar, alphai)
!	end do
!	close(20)
...
!.... Build the RHS for du/dalpha
	...
	ra = czero
        ...
        Ab = iota * A + two * alphal * Ex - three * iota * Ex / (x(i+1)-x(i))
...
!.... save a non interpolated field file
      ...
      do i = is, ie
	write(22,"(6(1pe13.6,1x))") x(i), real(alphah(i)), aimag(alphah(i)), &
