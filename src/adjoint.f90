!==============================================================================
      subroutine adjoint 
!
!     Solves the spatial adjoint eigenvalue problem for a parallel base flow
!
!     S. Scott Collis
!==============================================================================
      use global
...
!.... Do for last station only (assume parallel flow)
      ...
      i = ie
      write(*,"('Spatial Discrete ALST for station ',i4,' s = ',1pe13.6)") &
        i, x(i)
...
!.... Eigensolution method 1
      ...
      if (info.ne.0) write(*,*) 'ZGETRF: ',info
#endif
...
!       end if
        ...
        open (unit=20,file='adjoint.out',form='formatted',status='unknown')
