...
!.... make the weights for integration
...
!.... statically eliminate the Neumann boundary conditions
	...
	do m = 2, ny
	  ...
	  B0(l0+1,m0+4) = B0(l0+1,m0+4) - A0(l0+1,4) * A0(4,m0+4) / A0(4,4)
	  B0(l0+2,m0+4) = B0(l0+2,m0+4) - A0(l0+2,4) * A0(4,m0+4) / A0(4,4)
	  B0(l0+3,m0+4) = B0(l0+3,m0+4) - A0(l0+3,4) * A0(4,m0+4) / A0(4,4)
	end do
	...
	do m = 2, ny
	  ...
	  B0(l0+1,m0+2) = B0(l0+1,m0+2) - A0(l0+1,2) * A0(4,m0+2) / A0(4,2)
	  B0(l0+2,m0+2) = B0(l0+2,m0+2) - A0(l0+2,2) * A0(4,m0+2) / A0(4,2)
	  B0(l0+3,m0+2) = B0(l0+3,m0+2) - A0(l0+3,2) * A0(4,m0+2) / A0(4,2)
	end do
