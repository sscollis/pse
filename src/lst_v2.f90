...
!
!     This version supportes mixing layer type flows
!
!     S. Scott Collis
!==============================================================================
      use global
...
!==============================================================================
      ...
      write(*,*) "WARNING:  Using Mixing Layer Far-field boundary conditions"
...
!.... Apply the boundary conditions to D0
      ...
      else if (ipwbc .eq. 3) then ! far-field condition
        D0(l0+4,:) = czero
        D0(:,l0+4) = czero
        D0(l0+4,l0+4) = cone
      else
